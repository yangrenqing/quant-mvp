...
`make show-start-here` is the quick companion to `make show-output-paths`: use it for the main entry paths, and use `make show-output-paths` for the fuller path map.
